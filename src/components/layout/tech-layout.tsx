...
import { Rocket, Terminal, GitBranch, Settings, Box, Share2, RefreshCw, Activity, Zap, BookOpen } from 'lucide-react';
    ...
    sql: [
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'joins', title: 'Joins & Relationships', href: '/sql#joins' }
        ]
      },
      {
        id: 'sql-advanced',
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'summary', title: 'SQL Summary', href: '/sql#summary' },
  ...
  return (
    <div className="flex min-h-screen relative w-full overflow-x-hidden" style={{ background: background }}>
      ...
      {!hideSidebar && (
        <aside
          className={`
            fixed left-0 z-50 w-full max-w-xs sm:max-w-sm lg:w-[320px] shadow-2xl
      ...
      <div className={`flex-1 flex flex-col ${!hideSidebar ? 'lg:ml-[350px]' : ''} min-h-screen w-full`}>
        {/* Mobile header */}
        ...
        <main className="flex-1 relative z-10 w-full" style={{ backgroundColor: disableBackground ? 'transparent' : 'var(--bg-primary)', paddingTop: '120px', minHeight: '100vh', color: 'var(--text-primary)' }}>
          <div className="w-full max-w-7xl 2xl:max-w-[1600px] 3xl:max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-10 2xl:px-14 transition-all duration-300" style={{ paddingTop: '2rem', paddingBottom: '2rem' }}>
