...
import { Terminal as TerminalIcon, Code, Coffee, Database, FileCode } from 'lucide-react';
          ...
          <div className="flex items-center space-x-4">
            ...
            {Object.entries(languages).map(([key, lang]) => (
              <button
                ...
                className={`px-3 py-1 rounded text-sm transition-colors ${currentLanguage === key
