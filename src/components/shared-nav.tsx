        ...
        <div className={`flex items-center justify-end pl-4 pt-0 pb-2 lg:pl-6 lg:pt-0 lg:pb-2 pr-0 w-full ${isScrolled ? 'pb-2' : ''} relative`}>
          ...
          >
            ...
            <div className="hidden md:flex items-center space-x-1 lg:space-x-2 text-sm font-medium">
              ...
              <Link
                href="/challenges"
                className={`transition-colors px-3 py-1.5 relative group font-bold nav-link-strict text-[#083D77] hover:text-sky-600 ${(pathname === '/challenges' || pathname?.startsWith('/challenges/')) ? 'bg-[#083D77]/10 rounded-full' : ''}`}
              >
                Challenges
              </Link>
