...
export default function CompactFooter() {
  ...
  const socialLinks = [
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/eduonehubglobal?igsh=MW95eGY3ancxbW5sMA==',
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/eduonehubgobal?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app',
      color: '#0077b5',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/share/1C4ddSw2Ub/?mibextid=wwXIfr',
      color: '#1877F2',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/@ohg365?si=Ojuh39dr1Wc1y2oa',
      color: '#FF0000',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
