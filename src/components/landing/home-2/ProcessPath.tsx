...
export default function ProcessPath() {
  return (
    <section className="compact-section pt-1 pb-4 w-full" style={{ backgroundColor: '#fcfcfc' }}>
      <div className="w-full max-w-7xl mx-auto px-[var(--space-md)] lg:px-[var(--space-lg)]">
        <div className="grid lg:grid-cols-12 gap-[var(--space-lg)] lg:gap-[var(--space-xl)] items-center w-full mx-auto">
          {/* Left Section - Image and Text */}
          <ScrollAnimate animation="fade-up" triggerOnce={false} className="lg:col-span-7 w-full">
            <div className="relative w-full">
              <div className="flex flex-col mb-[var(--space-md)] w-full">
                <span className="text-blue-600 font-bold tracking-widest uppercase text-sm mb-3 block">Methodology</span>
                <h2 className="font-bold text-gray-900 mb-6 tracking-tight" style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', lineHeight: '1.2' }}>
          ...
          <ScrollAnimate animation="fade-up" triggerOnce={false} className="lg:col-span-5 flex justify-center">
