        ...
        {courses.map((course) => (
          ...
          >
            ...
            <div className="p-6 pl-28 relative flex flex-col justify-center h-full">
              <div className="absolute top-2 right-4 text-[10px] font-bold uppercase tracking-wide text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 px-2 py-1 rounded-full">
                {course.category}
              </div>
              <h3
