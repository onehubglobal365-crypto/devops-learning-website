                ...
                {steps.map((step, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Content Card */}
                      <div
                        className={`rounded-l-2xl rounded-r-[100px] pl-6 pr-10 py-5 transition-all duration-300 cursor-pointer hover-lift hover-glow shadow-lg bg-white ${isActive ? 'scale-105 shadow-xl ring-1 ring-blue-500' : ''
                          }`}
                        style={{
