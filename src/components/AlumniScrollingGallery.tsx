            ...
            {displayAlumni.map((alumniProfile, index) => (
              ...
              >
                <div className="relative h-full">
                  ...
                  <div
                    className={`absolute inset-0 rounded-bl-[2rem] rounded-br-[5rem] rounded-tr-lg rounded-tl-lg transform transition-transform duration-300 group-hover:rotate-0 ${index % 3 === 0 ? 'bg-emerald-500 rotate-[-6deg]' :
                  ...
                  {/* Main Card */}
                  <div className="relative bg-white h-full shadow-lg flex flex-col transition-transform duration-300 group-hover:-translate-y-2 rounded-bl-[2rem] rounded-br-[5rem] rounded-tr-lg rounded-tl-lg">

                    {/* Header Section */}
                    <div className="relative flex items-start pt-4 pl-4">
                      {/* Purple Photo Container - OUTSIDE Positioned */}
                      <div className="absolute -top-6 -left-6 w-28 h-28 bg-[#9F21E3] rounded-2xl overflow-hidden shadow-xl z-10">
                      ...
                      <div className="flex-1 pt-4 pl-3 pr-2 ml-24">
                        <h3 className="text-xl font-bold text-[#9F21E3] leading-tight mb-1">
                          {alumniProfile.name}
                        </h3>
