...
function LevelChallengeContent() {
                ...
                <div className="space-y-3">
                  {currentMcq.options.map((option, index) => (
                    <button
                      ...
                      className={`w-full p-4 rounded-xl text-left transition-all ${mcqAnswers[currentMcqIndex] === index
              ...
              <div className="mt-8 flex flex-wrap gap-2 justify-center">
                {levelData.mcqs.map((_, index) => (
                  <button
                    ...
                    className={`w-8 h-8 rounded-lg text-sm font-semibold transition-all ${index === currentMcqIndex
                        ? `bg-gradient-to-r ${challengeData.color} text-white`
