    ...
    <div className="min-h-screen bg-[var(--bg-primary)] transition-colors duration-300">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-orange-200/40 rounded-full blur-[100px] opacity-70"
        />
        <motion.div
          animate={{
            x: [0, 80, 0],
          ...
          className="absolute -bottom-40 -left-40 w-96 h-96 bg-orange-300/50 rounded-full blur-3xl opacity-80"
        />
      </div>
