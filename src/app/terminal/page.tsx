...
export default function TerminalPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] transition-colors duration-300 relative overflow-x-hidden">
      {/* Animated Background */}
      {isMounted && (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
          <div
            ...
            className="group text-center p-6 rounded-2xl bg-white border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2 cursor-pointer"
          >
            <div className="mb-4 transform group-hover:scale-110 group-hover:rotate-6 transition-transform duration-500 inline-block">
              <Terminal className="w-16 h-16 text-green-600 transition-colors" />
            </div>
          ...
          >
            <div className="mb-4 transform group-hover:scale-110 group-hover:rotate-6 transition-transform duration-500 inline-block">
              <Code2 className="w-16 h-16 text-blue-600 transition-colors" />
            </div>
          ...
          >
            <div className="mb-4 transform group-hover:scale-110 group-hover:rotate-6 transition-transform duration-500 inline-block">
              <FileCode className="w-16 h-16 text-orange-600 transition-colors" />
            </div>
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-8 pb-16">
        <div className="text-center mb-8">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Live Code <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-green-600">Editor</span>
          </h2>
      ...
      <div className="max-w-7xl mx-auto px-8 pb-16">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Command <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-600">Reference</span>
          </h2>
      ...
      <div className="max-w-7xl mx-auto px-8 pb-16">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Learning <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-orange-600">Tips</span>
          </h2>
