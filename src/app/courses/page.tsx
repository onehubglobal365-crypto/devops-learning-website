...
export default function CoursesPage() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[var(--bg-primary)] transition-colors duration-300 relative">
      {/* Animated Background */}
      {isMounted && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {courses.map((course, index) => (
              <Link
                ...
                className="group relative rounded-tl-[50px] rounded-br-[50px] rounded-tr-2xl rounded-bl-2xl p-8 overflow-hidden border border-gray-100 dark:border-white/10 card-hover-effect hover-glow-soft shadow-lg transition-all duration-300"
                style={{
