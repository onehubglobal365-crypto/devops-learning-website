...
services:
  ...
  return (
    <TechLayout onThisPage={pageHeadings} technology="devops" activeSection={activeSection} setActiveSection={setActiveSection}>
      <div className="bg-gradient-to-r from-orange-300 to-sky-400 dark:from-orange-900/40 dark:to-sky-900/40 min-h-screen rounded-2xl p-6 shadow-xl text-slate-900 dark:text-gray-100">
        {renderContent()}
      </div>
    </TechLayout>
  );
